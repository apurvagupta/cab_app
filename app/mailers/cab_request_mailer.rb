...
# send a signup email to the user, pass in the user object that contains the user's email address
  def send_email(cab_request,pick_up_date,pick_up_time,admin_emails,vendor_email)
    mail(cc: [admin_emails,vendor_email] , subject: "[Cab Request]", body:  "Name:\t" + cab_request.traveler_name+
