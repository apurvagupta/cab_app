...
describe CabRequestsController do
  ...
  context 'create' do
    it 'should redirect to show path if saved' do
      @cab_request  = { requester: "Priyanka Pathak", traveler_name: "self",pick_up_date: "07/02/2913", pick_up_date_time: Time.new(2913, 02, 07, 4, 0, 0, "+05:30"), contact_no: "9039409828", source: "Guest House", destination: "ThoughtWorks", no_of_passengers: 1, comments: "something" }
