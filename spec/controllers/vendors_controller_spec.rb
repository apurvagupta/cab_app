...
describe VendorsController do
  ...
  context 'Edit' do
    it 'should find a particular Vendor' do
      get :edit ,id: @active_valid_vendor.id
      response.should be_success
  ...
  context 'create' do
    it 'should redirect to the index page when saved' do
      post :create ,vendor: attributes_for(:inactive_valid_vendor)
  ...
  context 'update' do
    it 'should redirect to index page when updated ' do
      put :update, id: @active_valid_vendor.id , vendor: attributes_for(:vendor, contact_no: '1234567890')
      response.should redirect_to(vendors_path)
    end
    it 'should render edit when not updated' do
      put :update ,id: @active_valid_vendor.id, vendor: attributes_for(:invalid_vendor)
      response.should render_template('vendors/edit')
    end
  end
  ...
  context 'destroy' do
    it 'should redirect to index page when deleted ' do
      delete :destroy, id: @active_valid_vendor.id
      response.should redirect_to(vendors_path)
    end
  end
